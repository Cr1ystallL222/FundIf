  ...
  return (
    <main className="min-h-screen">
      ...
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">
        {/* Background gradient effect - now animated */}
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          <FadeIn duration={0.6}>
            <div className="glass-panel p-8 sm:p-12 lg:p-16 space-y-8">
              ...
              >
                <StaggerContainer className="flex flex-wrap justify-center gap-8" staggerDelay={0.15} initialDelay={0.6}>
                  <StaggerItem>
          ...
          {!isLoading && !isError && sortedCampaigns.length > 0 && (
            ...
            >
              {sortedCampaigns.map((campaignAddress) => (
                <StaggerItem key={campaignAddress}>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <StaggerItem>
              ...
              >
                <motion.div
                  className="w-12 h-12 mx-auto mb-4 rounded-full bg-secondary/20 flex items-center justify-center"
